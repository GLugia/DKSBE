...
{
	public unsafe class Unk_94 : PtrController
	{
		public List_SE<byte> array { get; private set; } = new();

		public override long size => this.array.size;
		...
		{
			this.array = CreateInstance<List_SE<byte>>(this.file_origin, this.origin - this.file_origin);
		}
